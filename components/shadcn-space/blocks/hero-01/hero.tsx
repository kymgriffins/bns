  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="w-full h-full relative z-10">
        <div className="relative w-full pt-16 md:pt-16 pb-4 md:pb-6">
            ...
            <div className="flex flex-col max-w-5xl mx-auto gap-8">
              <div className="relative flex flex-col text-center items-center sm:gap-6 gap-4">
                <motion.h1
                  ...
                  className="lg:text-6xl md:text-5xl text-4xl font-medium leading-tight md:leading-tight lg:leading-tight text-white"
                >
                  Follow the Budget.{" "}
                  <span
                ...
                <motion.p
                  ...
                  className="text-base font-normal max-w-2xl text-gray-200"
                >
              ...
              >
                <Link href="/auth/sign-up">
                  <Button className="relative text-sm font-medium rounded-full h-12 p-1 ps-6 pe-14 group transition-all duration-500 hover:ps-14 hover:pe-6 w-fit overflow-hidden bg-white text-black hover:bg-white/90">
                ...
                <Link href="/reports">
                  <Button variant="outline" className="relative text-sm font-medium rounded-full h-12 px-6 group bg-transparent text-white border-white hover:bg-white hover:text-black">
                ...
                <div className="flex items-center sm:gap-7 gap-3">
                  ...
                  <div className="gap-1 flex flex-col items-start">
                    ...
                    <p className="sm:text-sm text-xs font-normal text-gray-300">
