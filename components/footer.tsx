      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-sm font-NeueMontreal text-gray-600 dark:text-white/60 mb-4">
        ...
        <div className="mt-16 pt-10 border-t border-gray-200 dark:border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
            {/* Tagline */}
            <p className="font-NeueMontreal text-gray-700 dark:text-white/70 text-lg md:text-xl font-light max-w-md">
